...
void lineFollow() {
    ...
    if (sR[0] == 1 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1){
       PWM_Right = 120;
       PWM_Left = 120;
    }  else if ((sR[0] == 0 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1) ||
                (sR[0] == 0 && sR[1] == 0 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1) ||
                (sR[0] == 0 && sR[1] == 0 && sR[2] == 0 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1)){
       PWM_Right = -80;
       PWM_Left = 80;
    } else if ((sR[0] == 0 && sR[1] == 0 && sR[2] == 0 && sR[3] == 0 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1) || 
               (sR[0] == 0 && sR[1] == 0 && sR[2] == 0 && sR[3] == 0 && sR[4] == 0 && sR[5] == 1 && sR[6] == 1 && sR[7] == 1) ||
       ...
       PWM_Right = 80;
       PWM_Left = 120;
    } else if (sR[0] == 0 && sR[1] == 0 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 0){
       PWM_Right = 100;
       PWM_Left = 120;
    } else if (sR[0] == 0 && sR[1] == 0 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 0 && sR[7] == 0){
       PWM_Right = 120;
       PWM_Left = 120;
    } else if (sR[0] == 0 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 0 && sR[7] == 0){
       PWM_Right = 120;
       PWM_Left = 100;
    } else if (sR[0] == 0 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 0 && sR[6] == 0 && sR[7] == 0){
       PWM_Right = 120;
       PWM_Left = 80;
    } else if ((sR[0] == 1 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 0 && sR[5] == 0 && sR[6] == 0 && sR[7] == 0) ||
               (sR[0] == 1 && sR[1] == 1 && sR[2] == 1 && sR[3] == 0 && sR[4] == 0 && sR[5] == 0 && sR[6] == 0 && sR[7] == 0) ||
               (sR[0] == 1 && sR[1] == 1 && sR[2] == 0 && sR[3] == 0 && sR[4] == 0 && sR[5] == 0 && sR[6] == 0 && sR[7] == 0)){
       PWM_Right = 80;
       PWM_Left = 0;
    } else if ((sR[0] == 1 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 1 && sR[7] == 0) ||
               (sR[0] == 1 && sR[1] == 1 && sR[2] == 1 && sR[3] == 1 && sR[4] == 1 && sR[5] == 1 && sR[6] == 0 && sR[7] == 0) ||
